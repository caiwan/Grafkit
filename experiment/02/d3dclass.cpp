...
void* D3DClass::operator new(unsigned int memorySize)
{
	unsigned int alignment;
	void* memoryBlockPtr;


	// Set the alignment of the D3DClass to 16 byte to support high speed XMMATRIX calculations and prevent crashes.
	alignment = 16;
...
void D3DClass::operator delete(void* memoryBlockPtr)
{
...
void D3DClass::GetVideoCardInfo(char* cardName)
{
