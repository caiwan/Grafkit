...
QGrafkitContextWidget::QGrafkitContextWidget(Grafkit::Renderer& render, QWidget* parent) : QWidget(parent)
    , View()
    , m_render(render)
    , m_isInited(false)
{
...
QPaintEngine* QGrafkitContextWidget::paintEngine() { return nullptr; }
...
void QGrafkitContextWidget::RefreshView(bool force) {
}
