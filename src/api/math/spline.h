...
/*
Quick and dirty spline class
*/

class Spline {

public:
	Spline(double * x, double *y, unsigned int n){
		m_x = new double [n];
		m_y = new double [n];
		m_b = new double [n];
		m_c	= new double [n];
		...
		// TODO: error codes are not handled here properly
		spline(n, 0, 0, 0, 0, m_x, m_y, m_b, m_c, m_d, &iFlag);
	...
	double calculate(double t){
		int seg = 0;
		return seval(m_n, t, m_x, m_y, m_b, m_c, m_d, &seg);
	}
...
int Spline::spline (int n, int end1, int end2,
            double slope1, double slope2,
            double x[], double y[],
            double b[], double c[], double d[],
            int *iflag)
...
double Spline::seval (int n, double u,
              double x[], double y[],
              double b[], double c[], double d[],
              int *last)
...
double Spline::deriv (int n, double u,
              double x[],
              double b[], double c[], double d[],
              int *last)
...
double Spline::sinteg (int n, double u,
              double x[], double y[],
              double b[], double c[], double d[],
              int *last)
