...
Grafkit::FileAssetManager::FileAssetManager(std::string root) :
	m_root(root)
{
...
Grafkit::FileAssetManager::~FileAssetManager()
{
}
...
/*
IAssetRef Grafkit::FileAssetManager::GetResourceByUUID(Guid uuid)
{
...
std::list<std::string> Grafkit::FileAssetManager::GetAssetList()
{
	return this->m_dirlist;
}


std::list<std::string> Grafkit::FileAssetManager::GetAssetList(AssetFileFilter * filter)
{
	filelist_t filelist;
...
inline Grafkit::FileAssetManager::FileAsset::~FileAsset()
{
	//if (m_data)
	free(m_data);
}
