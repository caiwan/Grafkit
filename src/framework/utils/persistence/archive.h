...
namespace Grafkit
{
    ...
    public:
        ...
        // I'm sorry, I had to do this "clever trick" on order to keep polimorphic stuff working a layer above
        class IStream
        {
        public:
            virtual ~IStream() {
...
#define SERIALIZER_FOR_STL2(type) \
    ...
    public:
        ...
        {
        public:
            InputStream(STREAM_TYPE& stream) : m_stream(stream) {
        ...
        {
        public:
            OutputStream(STREAM_TYPE& stream) : m_stream(stream) {
            } //: Stream<STREAM_TYPE>(stream){}
            ...
            {
                return bool(m_stream); /*!m_stream.fail()*/
            };
