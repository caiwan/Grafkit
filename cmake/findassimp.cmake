...
if(WIN32)
	...
	if(MSVC12 OR MSVC14)
		...
		find_library(ASSIMP_DLL_RELEASE	 assimp-${ASSIMP_MSVC_VERSION}-mt.dll 	PATHS ${ASSIMP_DLL_BASEDIR})
		find_library(ASSIMP_DLL_DEBUG	 assimp-${ASSIMP_MSVC_VERSION}-mtd.dll	PATHS ${ASSIMP_DLL_BASEDIR})
