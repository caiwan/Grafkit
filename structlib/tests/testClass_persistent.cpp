...
void ArchivePersistentTestClass::serialize(FWutils::Archive &stream)
{
	if (stream.isStoring()) {
		stream << m_data.m_int;
...
void ArchivePersistentExtendedTestClass::serialize(FWutils::Archive & stream)
{
}
...
void ArchivePersistentLongClass::serialize(FWutils::Archive & stream)
{
}
