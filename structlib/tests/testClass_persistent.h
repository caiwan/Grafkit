...
*/
class ArchivePersistentTestClass : public FWutils::Persistent {
public:
	...
	virtual void serialize(FWutils::Archive& stream);
...
*/
class ArchivePersistentExtendedTestClass : public FWutils::Persistent {
public:
...
/** 
*/
class ArchivePersistentLongClass : public FWutils::Persistent {
public:
